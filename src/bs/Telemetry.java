...
public class Telemetry {
	 ...
	 * Constructor
	 * 
	 * @param ultrasonic the value of the robot's ultrasonic sensor
	 * @param light the value of the robot's light sensor
	 * @param touch true if the touch sensor is activated, false otherwise
	 * @param sound the value of the robot's sound sensor
	 * @param speedLeft the speed of the robot's left motor
	 * @param speedRight the speed of the robot's right motor
	 * @param angleArm the angle of the robot's arm
	 * @param receiveTime the time in milliseconds from the initialization of the program that this telemetry was received
	 */
	 ...
	 * @return the value of the ultrasonic sensor stored in this Telemetry object
	 */
	 ...
	 * @param ultrasonic the value of the ultrasonic sensor to store
	 */
	 ...
	 * @param ultrasonic the value of the light sensor to store
	 */
	 ...
	 * @return true if the touch sensor is set as activated in this Telemetry object, false otherwise
	 */
	 ...
	 * @param true if this telemetry sensor is to show that the touch sensor was activated, false otherwise
	 */
	 ...
	 * @param ultrasonic the sound of the ultrasonic sensor to store
	 */
	 ...
	 * @param the speed of the left motor to store in this Telemetry object
	 */
	 ...
	 * @param the speed of the right motor to store in this Telemetry object
	 */
	 ...
	 * @param the angle of the robot arm to store in this Telemetry object
	 */
	...
	/**
	 * Gets the time in milliseconds from the initialization of the program that this telemetry was received
	 * @return the time in milliseconds from the initialization of the program that this telemetry was received
	 */
	...
	/**
	 * Sets the time in milliseconds from the initialization of the program that this telemetry was received
	 * @param the time in milliseconds from the initialization of the program that this telemetry was received
	 */
